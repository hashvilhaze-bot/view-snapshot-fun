...
const sides = [
  ...
  {
    t: "הצד הנפאלי",
    d: "ההפעלה בשטח נעשית עם שותף מקומי שמפעיל טרקים ומסעות נהר מקתמנדו משנת 2010: מדריכים מוסמכים שגדלו באזורים שאליהם הולכים, פורטרים מבוטחים, ואיש קשר בקתמנדו שזמין לאורך הטיול.",
