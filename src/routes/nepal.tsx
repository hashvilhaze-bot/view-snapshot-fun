...
const experiences = [
  {
    ...
    image: annapurna1,
    imageAlt: "מטיילים במחנה הבסיס של אנאפורנה מול קיר הפסגה באור בוקר",
    to: "/treks",
  },
  {
    slug: "kathmandu",
  ...
  },
  {
    ...
    image: pokhara1,
    imageAlt: "סירה על אגם פווה בפוקרה, גבעות ירוקות משתקפות במים",
  ...
  },
  {
    ...
    image: yoga1,
    imageAlt: "מרפסת בית תה פשוט בהרים, שולחנות עץ ונוף פתוח",
  ...
  },
  {
    ...
    image: rafting1,
    imageAlt: "רפסודה עם חותרים בתוך אשדות בנהר נפאלי",
